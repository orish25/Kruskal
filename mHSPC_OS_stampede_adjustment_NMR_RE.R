...
model_normal_identity_nmr_re <- function()
{
...
model_mams_adjust_nmr_re <- function()
{
...
cross_meandiff_re <- cross_effect(bugs_object = bugs_object_re_mams, t_names = c(1:8), med = TRUE, exp = FALSE)
